 ...
 *   <li>accept() sử dụng optimistic check để tránh race condition khi 2 driver cùng nhận.</li>
 * </ul>
 */
@Slf4j
@Service
...
public class TripService {
     ...
     *   <li>Tính giá (tái sử dụng PricingService) + snapshot surge tại thời điểm đặt.</li>
    ...
    /**
     * Driver bắt đầu chuyến đi. Chỉ trip ACCEPTED mới start được.
     *
     * @param driverEmail email từ JWT principal
     * @param tripId      ID cuốc xe
     */
